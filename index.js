...
let gameData = {
    ...
    // Default screen when new game starts
    newGame: function () {
        console.log("\n* * * * * * * * * * * * * * * * * *".rainbow);
    ...
    promptForLetters: function () { //promptForLetters start
        var that = this;
        ...
        if (this.guessesRemaining > 0) {
            inquirer.prompt([{
                ...
                if (that.guessedLetters.indexOf(userGuess) != -1) {
                    ...
                    console.log('\033c'); // Clears the terminal
                    // Stores user guesses into an array
                    that.guessedLetters.push(userGuess);
                    that.correctLetters++;

                    if (that.correctLetters == chosenWord.length) { //All letters guessed
                        console.log('\033c'); // Clears the terminal
                        console.log("\n* * * * * * * * * * * * * * * * * * * * * * *".rainbow);
